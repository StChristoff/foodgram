...
- Публиковать и редактировать от своего имени рецепты блюд, с указанием: ингредиентов (из предустановленого списка), тегов, времени приготовления, описания алгоритма приготовления и изображения готового блюда.
...
- Фронтенд для проекта выполнен на JavaScript (React), разработан и любезно предоставлен [Яндекс.Практикум](https://practicum.yandex.ru/).
...
https://<IP или доменное имя>/api/docs/ (при запуске на удалённой машине)
http://127.0.0.1/api/docs/ (при локальном запуске)
...
- Добавить возможность добавления ингредиента, если его нет в предустановленном списке, с предварительной валидацией.
- Добавить возможность аутентификации по OpenID.
- Добавить комментарии к рецептам.
- Добавить рейтинг рецептов по оценкам других авторов.
- Добавить сортировку рецептов по рейтингу.
